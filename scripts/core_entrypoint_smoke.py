...
VALID_NATIVE_STATES = {"AVAILABLE", "HEALTHY", "UNAVAILABLE"}


def _valid_native_state(status):
    return status in VALID_NATIVE_STATES
...
def run():
    ...
    try:
        ...
        native_state = router.states(probe=False)["native"].status
        assert _valid_native_state(native_state)
        ...
        result["functions"] = {
            ...
            "backend_router": "PASS",
            "native_availability": native_state,
            "change_guard": "PASS",
